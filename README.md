...
To build the final jar and optimize the AbsaUGDTBillpaynemt application for production, run:
...
Then navigate to [http://localhost:1680](http://localhost:1680) in your browser.
